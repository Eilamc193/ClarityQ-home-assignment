  ...
  if (!persona || !company) {
    return (
      <div className="p-8 flex items-center justify-center h-64">
        <p className="text-gray-400 text-sm">Select a persona from the Persona Finder first.</p>
      </div>
    )
  }
  ...
  return (
    <div className="p-8 max-w-5xl">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-xl font-semibold text-gray-900">AI Email Composer</h1>
        <span className="text-sm text-gray-400 ml-1">— powered by Claude</span>
      </div>
      ...
      <div className="grid grid-cols-5 gap-6">
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Prospect</p>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{persona.title} · {company.name}</p>
              </div>
            </div>
          </div>
          ...
          {/* Signals context */}
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Signals to Leverage</p>
              ...
              {company.signals.map((signal) => (
                <div key={signal.id} className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-700 font-medium leading-snug">{signal.title}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Email type */}
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Email Type</p>
          ...
          >
            {loading ? (
              ...
              <><Zap size={16} /> Generate with Claude</>
            )}
          </button>
        </div>
        ...
        <div className="col-span-3">
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm h-full min-h-96 flex flex-col">
            {/* Toolbar */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
              <p className="text-sm font-semibold text-gray-700">Generated Email</p>
              {result && (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={handleCopy}
                    className="flex items-center gap-1.5 text-xs font-medium bg-gray-100 text-gray-700 px-2.5 py-1.5 rounded-lg hover:bg-gray-200 transition-colors"
                  >
            ...
            <div className="flex-1 px-5 py-4">
              ...
              {!result && !loading && !error && (
                <div className="h-full flex items-center justify-center text-center">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Configure options and click<br />"Generate with Claude"</p>
                  </div>
                </div>
              )}
              ...
              {result && !loading && (
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 font-medium mb-1">Body</p>
                  ...
                  {result.personalization_notes?.length > 0 && (
                    <div className="border-t border-gray-100 pt-3">
                      <p className="text-xs font-semibold text-indigo-500 uppercase tracking-wide mb-2">Personalization used</p>
